...
import MessengerWebAppProvider from "@/components/tma/MessengerWebAppProvider";
  ...
  return (
    <>
      ...
      <Suspense fallback={null}>
        <TelegramWebAppProvider slug={slug}>
          <MessengerWebAppProvider slug={slug}>{children}</MessengerWebAppProvider>
