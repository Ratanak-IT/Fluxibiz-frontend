...
>
  ...
  <Card className="group relative overflow-hidden rounded-3xl border-[0.5px] border-hairline bg-white p-7 transition-all duration-500 ease-out dark:bg-card sm:p-8">
    ...
    >
      ...
      <div className="relative flex min-h-40 w-full shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-white p-3 dark:bg-card sm:w-1/2 sm:min-h-50">
        <Image
