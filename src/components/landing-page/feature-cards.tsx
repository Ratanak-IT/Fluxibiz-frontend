import { LayoutDashboard, PackageSearch, Utensils, type LucideIcon } from "lucide-react";
  ...
  return (
    <Section id="features">
      <span className="mx-auto mb-5 flex w-fit items-center gap-2 rounded-full bg-brand-soft py-1 pl-1 pr-3 text-brand-ink">
        ...
        <span className="text-xs font-medium">Built for busy counters</span>
      </span>
      ...
      <ol className="mt-16 grid grid-cols-1 gap-8 md:mt-20 md:grid-cols-3 md:items-stretch md:gap-6">
        {FEATURES.map((feature, index) => {
          ...
          return (
            <ScrollReveal key={feature.title} direction="up" delay={index * 120} className="h-full">
              <li className="h-full">
