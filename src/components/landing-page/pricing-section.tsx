...
function PlanCard({
    ...
    return (
        ...
        >
            {plan.popular ? (
                <Badge className="absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full bg-brand-ink px-3 py-1 text-[10px] font-semibold text-white hover:bg-brand-ink"></Badge>
            ) : null}
        ...
        <Section id="pricing" className="overflow-visible">
            <div className="text-center">
                ...
                <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-muted-foreground">
                    Simple, honest pricing that scales with your counter —
                    flexible, affordable, and built to grow with you.
                </p>
                    ...
                    >
                        <PlanCard
                            ...
                            onArrowKey={(direction) =>
                                moveSelection(plan.id, direction)
                            }
                        />
                    </ScrollReveal>
                ))}
