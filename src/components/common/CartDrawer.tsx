  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        {totalItems > 0 && (
          <span className="absolute -right-0.5 -top-0.5 flex h-[18px] min-w-[18px] items-center justify-center rounded-full bg-pink-500 px-1 text-[10px] font-bold leading-none text-white ring-2 ring-white dark:ring-neutral-900">
      ...
      <SheetContent
        side="right"
        className="flex w-full flex-col p-0 sm:w-[440px]"
      >
        ...
        {cart && cart.stores.length > 0 && (
          <div className="border-t border-neutral-200 px-5 py-3 dark:border-border">
            <p className="text-center text-xs leading-relaxed text-neutral-500 dark:text-muted-foreground">
              {cart.totalItems} {cart.totalItems === 1 ? "item" : "items"} · pay
              one shop at a time
            </p>
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-3 py-16">
      ...
      <p className="max-w-[260px] text-center text-sm text-neutral-500 dark:text-muted-foreground">
        Add items from any shop. They stay grouped by shop, and you pay one shop
        at a time.
      </p>
    </div>
  );
