...
export const Chart = () => (
  <div
    className={
      'dark:shadow-none shadow-xl overflow-hidden rounded-lg border dark:border-neutral-800 w-[300px] animate-float-overview'
    }
  >
    <div className={'absolute p-4 dark:text-neutral-100 text-neutral-900'}>
      <div className={'font-medium'}>Total's customer</div>
      <div className={'font-bold text-3xl'}>+900%</div>
    </div>
    <div className={'dark:bg-neutral-800 bg-gray-100 dark:bg-grid-neutral-700 bg-grid-neutral-200'}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 653 465">
        <motion.path
          ...
          className={'dark:fill-green-400 fill-green-200'}
        />
        <motion.path
          ...
          fill="none"
          className={'dark:stroke-primary stroke-primary'}
          strokeWidth="4"
        />
      </svg>
    </div>
