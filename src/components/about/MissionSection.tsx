...
export default function MissionSection({
  ...
  return (
    <section
    className={`ms-scope w-full overflow-hidden 
        bg-background 
        px-[5.5%] pb-24 pt-[5.5rem] 
        font-googlesans antialiased 
        ${className}`
    }
>
    <div className="mb-[3.2rem] max-w-[900px]">
        ...
        >
            <span
                className="
                    h-1.5 w-1.5 
                    animate-[ms-pulse_2.2s_ease-in-out_infinite] 
                    rounded-full 
                    bg-brand
                    motion-reduce:animate-none
                "
            ...
            {loopedCards.map((card, i) => (
                ...
                <div
                    ...
                    className="
                        ...
                        hover:shadow-[0_22px_44px_-18px_rgba(3,7,18,0.2)]
