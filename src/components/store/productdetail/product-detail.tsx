...
import { useGetProductQuery } from "@/lib/store/productdetail/productApi";
      ...
      {discountPct}% OFF
          ...
          <div>
            <p className="mb-2 text-sm text-muted-foreground ">
              Sugar Level:{" "}
              <span className="font-medium text-foreground">{sugarLevel}%</span>
            </p>
        ...
        "
          ...
          {/* A silent failure here reads as a dead button, so say something. */}
          {addError && (
