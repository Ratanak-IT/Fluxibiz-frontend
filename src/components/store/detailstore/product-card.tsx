          ...
          <div className={cn("flex min-w-0 flex-1 flex-col justify-between p-2.5 pr-2 @xs:p-3", outOfStock && "filter blur-[0.5px]")}>
            <CardHeader className="gap-0.5 p-0">
              ...
              <div className="flex items-center gap-2">
                <p className="text-xs font-bold text-red-500 @xs:text-sm @sm:text-base dark:text-red-400">
            ...
            <div className="mt-1 flex flex-wrap items-center gap-1.5">
              ...
              {outOfStock && (
                <span className="text-[10px] font-bold text-red-600 @xs:text-[11px] @sm:text-xs dark:text-red-500">
