    ...
    >
      ...
      {id === 'simple' && (
        <>
          <path
            ...
            d="M7 10h18"
            style={s(0, {
              transform: on ? 'scaleX(0.5)' : 'scaleX(1)',
            })}
          />
          ...
          <path
            ...
            style={s(
              2,
              {
                transform: on ? 'scaleX(0.26)' : 'scaleX(1)',
              },
              70,
            )}
          />
      ...
      {id === 'connected' && (
        <>
          <path
            pathLength={1}
            d="M16 16L8 9.5M16 16l8.5-6.5M16 16v9.5"
            style={s(0)}
          />
          <circle
            pathLength={1}
            ...
            r="3.2"
            style={s(1, {
              transform: on ? 'scale(1.24)' : 'scale(1)',
            })}
          />
          <circle
            pathLength={1}
      ...
      {/* Free trial with high quality — dollar badge */}
      {id === 'fair' && (
        <>
          {/* Outer coin */}
          <circle
          ...
          <path
            pathLength={1}
            d="M19.2 11.8c-.8-.8-2-1.2-3.4-1.2-2.1 0-3.6 1.1-3.6 2.8 0 1.9 1.6 2.5 3.8 3 2.1.5 3.7 1.1 3.7 3 0 1.8-1.6 3-3.9 3-1.6 0-3-.5-4-1.5M16 8.5v15"
            style={s(
              2,
              {
                transform: on
                  ? 'translateY(-0.5px) scale(1.04)'
          ...
          <path
            pathLength={1}
            d="M25.2 7.3l.7 1.7 1.7.7-1.7.7-.7 1.7-.7-1.7-1.7-.7 1.7-.7.7-1.7Z"
            style={s(
              3,
              {
                transform: on
      ...
      {/* Here for the long run — a segment runs the loop */}
      {id === 'longrun' && (
        <>
          <path
            pathLength={1}
